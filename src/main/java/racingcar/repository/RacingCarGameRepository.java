...
public class RacingCarGameRepository {
    ...
    public long saveResult(RacingGame racingGame) {
        String winners = String.join(", ", racingGame.getRacingWinners().names());
    ...
    public void saveDetailResult(long playId, RacingGame racingGame) {
        ...
        Cars participationCars = racingGame.getParticipationCars();

        for (Car participationCar : participationCars.getCars()) {
