...
class RacingCarDAOTest {
    ...
    void setUp() {
        ...
        jdbcTemplate.execute("CREATE TABLE RACING_CAR(" +
            "id INT NOT NULL AUTO_INCREMENT, GROUP_ID INT NOT NULL, NAME VARCHAR(50) NOT NULL"
        ...
        jdbcTemplate.batchUpdate(
            "INSERT INTO RACING_CAR(GROUP_ID, NAME, POSITION) VALUES (?,?,?,?)",
            splitValues);
    ...
    void updateRacingCar() {
        ...
        RacingCar update = new RacingCar(5, 33, "Joooooohn", 1);
        dao.updateRacingCar(update);

        List<RacingCar> data = dao.findRacingCarByGroupId(33);
        assertThat(data.get(0).getName()).isEqualTo("Joooooohn");
    }
